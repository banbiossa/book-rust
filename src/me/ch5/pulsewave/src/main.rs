...
fn main() {
    ...
    let mut fw = hound::WavWriter::create("pulsewave.wav", spec).unwrap();
...
fn noteno_to_hz(no: i32) -> f32 {
    440.0 * (2.0 as f32).powf((no - 69) as f32 / 12.0)
}
fn calc_len(bpm: usize, n: usize) -> usize {
    ((4.0 / n as f32) * (60.0 / bpm as f32) * SAMPLE_RATE as f32) as usize
}
...
fn pulse(no: i32, len: usize, gain: f32, duty: f32) -> Vec<f32> {
    ...
    for i in 0..len {
        let saw = (i as f32 / form_samples as f32) % 1.0;
